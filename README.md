...
- **[hnsw-go](https://github.com/nijaru/hnsw-go)** - Pure-Go HNSW vector search with mmap-backed persistence, filtering, and segment merging
...
- **[pi-goal](https://github.com/nijaru/pi-goal)** - Persistent, session-scoped goals for pi. Explicit budgets, pause/resume, and evidence-gated completion
- **[pi-workflows](https://github.com/nijaru/pi-workflows)** - Durable script-as-plan orchestration for pi. Parallel agents, budgets, journals, and resumable runs
...
- **[sy](https://github.com/nijaru/sy)** - Rust file synchronization with delta transfers, parallel I/O, SSH, and reflink support
- **[aku](https://github.com/nijaru/aku)** - Typesafe Go API framework built on net/http, with request extraction, validation, and OpenAPI generation
